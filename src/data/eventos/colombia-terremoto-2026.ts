...
export const colombiaTerremoto2026: Evento = {
  ...
  ayudas: [
    ...
    },
    {
      ...
      pendiente:
        "No hemos confirmado el canal exacto de contacto de las demás aseguradoras desplegadas (Allianz, Axa Colpatria, Aseguradora Solidaria, BBVA Seguros, Colmena, Chubb, HDI, La Equidad, La Previsora, Mapfre, Seguros del Estado y Zurich).",
